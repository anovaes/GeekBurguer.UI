...
{
    public class UIChangedService : IUIChangedService
    {
        ...
        public UIChangedService(IMapper mapper, IConfiguration configuration)
        {
            _mapper = mapper;
        ...
        //public void AddToMessageList(IEnumerable<EntityEntry<GeekBurguer.UI.Contract.Product>> changes)
        //{
        //    _messages.AddRange(changes
        //    .Where(entity => entity.State != EntityState.Detached
        //            && entity.State != EntityState.Unchanged)
        //    .Select(GetMessage,null).ToList());
        //}

        public Message GetMessage(EntityEntry<Orders.Contract.Product> entity)
        {
        ...
        void IUIChangedService.SendMessagesAsync()
        {
            throw new NotImplementedException();
        }

        void IUIChangedService.AddToMessageList(IEnumerable<EntityEntry<GeekBurguer.UI.Contract.Product>> changes)
        {
            throw new NotImplementedException();
        }
    }
